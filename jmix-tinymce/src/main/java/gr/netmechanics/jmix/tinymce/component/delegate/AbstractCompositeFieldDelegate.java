...
import io.jmix.flowui.component.delegate.AbstractValueComponentDelegate;
 ...
 */
public abstract class AbstractCompositeFieldDelegate<C extends AbstractCompositeField<?, ?, V>, T, V>
    ...
    public AbstractCompositeFieldDelegate(C component) {
        super(component);
    }
